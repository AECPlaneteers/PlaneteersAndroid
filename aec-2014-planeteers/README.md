...
This repository contains the source code for the [AECPlaneteers](http://www.androidbootstrap.com/)
Android app available from [Google Play](https://play.google.com/store/apps/details?id=com.citrrus.aec.planeteers).

Please see the [issues](https://github.com.citrrus.aec.planeteers/issues) section
to report any bugs or feature requests and to see the list of known issues.

Have a questions about AECPlaneteers? Ask away on the [com-citrrus-aec-planeteers discussion forum](https://groups.google.com/forum/#!forum/com-citrrus-aec-planeteers). 

<a href="https://play.google.com/store/apps/details?id=com.citrrus.aec.planeteers" alt="Download from Google Play">
...
After generating the app on [AndroidBootstrap.com](http://www.androidbootstrap.com) the folder structure of the source code for the app will change:
  ...
  - From: __com.citrrus.aec.planeteers__ 
  - To: __com/notify/app/mobile__

At that point all the source files that were located in ____com.citrrus.aec.planeteers__ will be moved to the new folder __com/notify/app/mobile__. 

All import statments that reference the old resources (__R.com.citrrus.aec.planeteers.R__) will now be renamed to the correct package. The artifact id's in the *pom.xml* (and various other places) will be replaced. The App Name will be replaced in the strings/etc. 
...
signed with a different key.  Manually uninstall AECPlaneteers from your device and
...
You can then import the AECPlaneteers project by doing File/Import/Gradle/Gradle Project
and the clicking the Browse button to point to the AECPlaneteers directory.  Click
...
AECPlaneteers is a result of a template project I've developed over the years as well as
...
AECPlaneteers is built on the awesome [Parse.com API](http://www.parse.com/)
...
[pull requests](https://github.com.citrrus.aec.planeteers/pulls).
